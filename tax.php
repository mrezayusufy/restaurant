...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<div class="row">
			<div class="col">
				<h6 class="m-0 font-weight-bold text-black">Tax List</h6>
			</div>
			<div class="col" align="right">
				<button type="button" name="add_tax" id="add_tax" class="btn btn-black btn-circle btn-sm"><i class="fas fa-plus"></i></button>
			</div>
		</div>
	</div>
	<div class="card-body">
