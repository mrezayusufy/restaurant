...
if(isset($_GET["action"])) {
	if($_GET["action"] == "tables") {
		...
		{
			$sub_array = array();
			$sub_array['name'] = html_entity_decode($row["table_name"]);
			$sub_array['capacity'] = $row["table_capacity"] . ' Person';
			$sub_array['status'] = $row["table_status"];
			$sub_array['id'] = $row["table_id"];
			$data[] = $sub_array;
		}
		$output = array(
